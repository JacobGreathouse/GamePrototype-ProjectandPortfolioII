...
namespace MatthewAssets
{
    ...
    {
        public ParticleSystem mparticleSystem; // Asigna el sistema de partículas en el Inspector
        ...
        {
            SetRandomRotation();
            mparticleSystem.Play(); // Inicia el sistema de partículas (opcional)
        }
        ...
        void SetRandomRotation()
        {
            ...
            mparticleSystem.transform.rotation = Quaternion.Euler(0f, 0f, randomZRotation);
        }
    }
}